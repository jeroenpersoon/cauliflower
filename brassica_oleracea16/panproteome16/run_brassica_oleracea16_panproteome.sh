...
# List data
realpath ../QC/proteins/*.faa > brassica_oleracea16_proteomes.txt
...
# Build panproteome
pantools build_panproteome -Xmx50g -Xms10g proteome_16_DB brassica_oleracea16_proteomes.txt
...
# BUSCO
pantools busco_protein --threads ${CPU} -Xmx100g --odb10=brassicales_odb10 proteome_16_DB


# optimal grouping
pantools optimal_grouping --threads ${CPU} -Xmx100g proteome_16_DB proteome_16_DB/busco/brassicales_odb10
