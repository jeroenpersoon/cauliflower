...
# List data
realpath ../QC/proteins/*.faa > cauliflower4_genomes.txt
realpath ../QC/annotations_filtered/*.gff | awk '{print FNR,$1;}' > cauliflower4_annotations.txt
...
# Build panproteome
pantools build_panproteome -Xmx50g -Xms10g proteome_4_DB cauliflower4_genomes.txt
...
# BUSCO
pantools busco_protein --threads ${CPU} -Xmx50g --odb10=brassicales_odb10 proteome_4_DB


# optimal grouping
pantools optimal_grouping --threads ${CPU} -Xmx50g proteome_4_DB proteome_4_DB/busco/brassicales_odb10
